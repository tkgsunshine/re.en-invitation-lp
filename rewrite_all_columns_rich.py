...
"""
    ...
    cta_box_html = """
              <div class="in-body-cta" style="background: rgba(255, 255, 255, 0.03); border: 1px solid var(--color-border-light); border-radius: 8px; padding: 32px 24px; margin: 48px 0; text-align: center;">
                ...
                <a href="preregister.html#entry-form" class="btn btn--primary" style="display: inline-block; padding: 14px 36px; font-weight: 700; text-decoration: none;">優先インビテーションに申し込む</a>
              </div>
"""
